...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
	...
	// Cargo los valores del request: fileid, reqn, buffer.
	fsipcbuf.write.req_fileid = fd->fd_file.id;
	ssize_t bytes_to_write = MIN(n, sizeof(fsipcbuf.write.req_buf));
	fsipcbuf.write.req_n = bytes_to_write;
	memmove(fsipcbuf.write.req_buf, buf, bytes_to_write);
	// Se procede a hacer la request. Devuelve la cantidad de bytes leidos.
